...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hw15.Entity.Card", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw15.Entity.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw15.Entity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw15.Entity.Card", b =>
                {
                    b.HasOne("hw15.Entity.User", "User")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("hw15.Entity.Transaction", b =>
                {
                    b.HasOne("hw15.Entity.Card", "DestinationCard")
                        .WithMany("TransactionsAsDestination")
                        .HasForeignKey("DestinationCardId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("hw15.Entity.Card", "SourceCard")
